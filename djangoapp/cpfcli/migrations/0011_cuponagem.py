# Generated by Django 5.0.1 on 2024-09-12 05:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['dtmov', 'codcli', 'idcampanha'], name='MSCUPONAGEM_DTMOV_IDX'), models.Index(fields=['numsorte'], name='MSCUPONAGEM_NUMSORTE_IDX')],
            },
        ),
    ]
